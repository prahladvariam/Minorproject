...
<link href="https://fonts.googleapis.com/css2?family=Noto+Sans&display=swap" rel="stylesheet">
  ...
  <div class="container-fluid" id="content">
    <div class="row" style="padding-top:35px" id="opcss">
    ...
    <div class="row" id="opcss">
      ...
      <div class="col-md-2" align="center" style="padding:10px; height:620px;">
	      <a href="createroll.php" style="margin-bottom:40px;" class="btn btn-primary form-control">Create Roll List</a></br>
	      <a href="getroll.php" style="margin-bottom:40px;" class="btn btn-primary form-control">Get Roll list</a></br>
      	<a href="update.php" style="margin-bottom:40px;" class="btn btn-primary form-control">Update Roll list</a></br>
      	<a href="attendance.php" style="margin-bottom:40px;"class="btn btn-primary form-control">Take Attendance</a></br>
      </div>
      <div class="col-md-5"></div>
    </div>
